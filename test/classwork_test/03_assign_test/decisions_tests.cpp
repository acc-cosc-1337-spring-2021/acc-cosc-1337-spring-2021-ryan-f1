...
TEST_CASE("Tests get_letter_grade_using_if", "should return corrosponding letter grades")
{
...
TEST_CASE("Tests get_letter_grade_using_switch", "should return corrosponding letter grades")
{
